...
class BleakGATTDescriptorNetgraph(BleakGATTDescriptor):
    """GATT Descriptor implementation for Netgraph backend"""
    ...
    def __init__(
        ...
        super(BleakGATTDescriptorNetgraph, self).__init__(obj)
