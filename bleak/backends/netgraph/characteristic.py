...
class BleakGATTCharacteristicNetgraph(BleakGATTCharacteristic):
    """GATT Characteristic implementation for the Netgraph backend"""
    ...
    def __init__(
        ...
        super(BleakGATTCharacteristicNetgraph, self).__init__(
